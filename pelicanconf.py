...
SITENAME = u'Bruno Adelé'
SITESUBTITLE = 'Ma page personnelle'
SITEURL = 'http://bruno.adele.im'
GITHUB_BLOG_SITE = 'https://github.com/badele/blog.jesuislibre.org'
#DISQUS_SITENAME = 'blogdejesuislibreorg'
THEME =  "/home/badele/private/projects/pelican-themes/jesuislibre"
...
# Links
LINKS = (('Home', '/'), ('projets', '/projets'), ('cv', '/cv'))
